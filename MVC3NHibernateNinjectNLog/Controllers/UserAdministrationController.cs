...
using MVC3NHibernateNinjectNLog.Infastructure.MyMembership;
using MVC3NHibernateNinjectNLog.Infastructure.MyMembership.Settings;

namespace MVC3NHibernateNinjectNLog.Controllers
{
